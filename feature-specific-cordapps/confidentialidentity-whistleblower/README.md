...
You can find [`SwapIdentitiesFlow` here](https://github.com/corda/samples-java/blob/master/feature-specific-cordapps/confidentialidentity-whistleblower/workflows/src/main/java/net/corda/examples/whistleblower/flows/BlowWhistleFlow.java#L117-L121).
