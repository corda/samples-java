...
//                "Only the lender property may change." using ((output.borrower == input.borrower)&&(output.amount == input.amount))
//                "The lender property must change in a transfer." using (input.lender != output.lender)
//                "The borrower cannot be become the new owner of the IOU." using (output.lender != input.borrower)
