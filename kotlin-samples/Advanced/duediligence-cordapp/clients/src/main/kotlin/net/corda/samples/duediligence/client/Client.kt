...
import net.corda.samples.duediligence.CORPORATE_ATTACHMENT_EXPECTED_CONTENTS
import net.corda.samples.duediligence.CORPORATE_ATTACTMENT_FILE_NAME
import net.corda.samples.duediligence.CORPORATE_JAR_PATH
...
private class UploadBlacklistClient {
    ...
    fun main(args: Array<String>) {
        ...
        args.forEach { arg ->
            ...
            val attachmentHash = uploadAttachment(proxy, CORPORATE_JAR_PATH)
            ...
            checkAttachment(attachmentJar, CORPORATE_ATTACTMENT_FILE_NAME, CORPORATE_ATTACHMENT_EXPECTED_CONTENTS)
