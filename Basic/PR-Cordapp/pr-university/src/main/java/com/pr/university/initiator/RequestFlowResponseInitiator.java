package com.pr.university.initiator;
...
public class RequestFlowResponseInitiator extends RequestFormFlow {
    ...
    public RequestFlowResponseInitiator(RequestForm newRequestState,
    ...
    public RequestFlowResponseInitiator(RequestFlowData data) {
        this(data.getNewRequestState(),
                data.getPreviousRequestState(),
                data.getCommand());
    }

    public RequestFlowResponseInitiator() {
    ...
    private void validateTxCommand(RequestFormContract.Commands command) {
        ...
        if (command instanceof RequestFormContract.Commands.UPDATE) {
            return;
        } else {
