...
public class SendOneOutputFlow {
    @InitiatingFlow
    @StartableByRPC
    public static class SendOneOutputFlowInitiator extends FlowLogic<SignedTransaction> {
        ...
        //public constructor
        public SendOneOutputFlowInitiator(Party receiver, Integer amount) {
    ...
    @InitiatedBy(SendOneOutputFlowInitiator.class)
    public static class SendOneOutputFlowResponder extends FlowLogic<Void>{
        //private variable
        private FlowSession counterpartySession;

        //Constructor
        public SendOneOutputFlowResponder(FlowSession counterpartySession) {
