...
public class SantaSessionStateTests {
    ...
    private final List<String> playerEmails = new ArrayList<>();
    ...
    public void unmatchingNameTest() {
        ...
        ChainMailSessionState st = new ChainMailSessionState(badNames, goodEmails, santa, elf);
    ...
    public void unmatchingEmailTest() {
        ...
        ChainMailSessionState st = new ChainMailSessionState(goodNames, badEmails, santa, elf);
    }
    ...
    public void tooFewPairingsTest() {
        ChainMailSessionState st = new ChainMailSessionState(playerNames, playerEmails, santa, elf);
