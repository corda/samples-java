...
public class IOUStateTests {
    ...
    /**
     * Task 8.
     * TODO: Override the [LinearState.getLinearId()] method and have it return a value created via your states's constructor.
     * Hint:
     ...
     * - The [linearId] is designed to link all {@link LinearState}s (which represent the states of an
     ...
     * updating vs creating a new states, make the default constructor private, to be used as a copy constructor.
     */
    @Test
